...
export const SectionDetailSkeleton = () => (
    <div className="fixed inset-0 z-50 flex flex-col bg-[#0B0F19] overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-80 p-6 border-r border-white/5 bg-black/20 shrink-0 space-y-6">
            ...
            <div className="flex-1 p-6 overflow-hidden flex flex-col space-y-4">
                ...
                <div className="flex-1 overflow-auto border border-white/10 rounded-xl bg-white/5 p-4 space-y-4">
                    <div className="flex justify-between gap-4 pb-4 border-b border-white/5">
...
export const DashboardSkeleton = () => (
    <div className="min-h-screen bg-[#0B0F19] p-6 md:p-10 font-sans">
        <div className="max-w-7xl mx-auto space-y-8">
            {/* Header */}
            <div className="flex flex-col md:flex-row justify-between gap-6 p-6 rounded-2xl bg-white/5 border border-white/5">
            ...
            {/* View Content */}
            <div className="rounded-3xl p-6 md:p-8 min-h-[600px] bg-white/5 border border-white/5 space-y-8">
